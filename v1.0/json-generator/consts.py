...
class ReferenceDataset(object):
    def __init__(self, genome=GENOME, read_length=READ_LENGTH, with_ercc=False, umis=False):
        ...
        if _genome == 'hg38' or _genome == 'grch38':
            ...
            self.star_genome_dir = "/data/reddylab/Reference_Data/IGVF/GRCh38/STAR_GRCh38_genome/" % (self.read_length-1)
            ...
            self.annotation_file = "/data/reddylab/Reference_Data/IGVF/GRCh38/Gencode/v43/IGVFFI7217ZMJZ.gtf" % (".with_ercc92" if with_ercc else "")
            self.rsem_dir = "/data/reddylab/Reference_Data/IGVF/GRCh38/RSEM_genome"% (".with_ercc92" if with_ercc else "")
            ...
            self.genome_fasta_files = ["/data/reddylab/Reference_Data/IGVF/GRCh38/fasta/IGVFFI0653VCGH.fasta" % (".with_ercc92" if with_ercc else "")]
            ...
            self.genome_sizes_file = "/data/reddylab/Reference_Data/IGVF/GRCm39/Gencode/mm39.chrom.sizes"
            self.encode_blacklist_bedfile = "/data/reddylab/Reference_Data/ENCODE/mm10.blacklist.bed" #TODO: Create liftover from mm10 to mm39
            self.genome_effective_size = "mm"
            ...
            self.regions_bed_file = "/data/reddylab/Reference_Data/Genomes/mm9/mm9.chrom.bed" #TODO: Update to mm39
